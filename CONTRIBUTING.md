...
| `make coverage-foundations` | Enforce 100% statement and branch coverage for fourteen critical state, review, configuration, permission, hygiene, ingestion, promotion, judging, effectiveness, held-out, changelog, and self-improvement modules. |
