...
| `make coverage-foundations` | Enforce 100% statement and branch coverage for six critical state, review, configuration, permission, hygiene, and promotion modules. |
