...
| `make coverage-foundations` | Enforce 100% statement and branch coverage for nine critical state, review, configuration, permission, hygiene, ingestion, deduplication, and promotion modules. |
